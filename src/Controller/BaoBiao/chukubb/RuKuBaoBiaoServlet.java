...
public class RuKuBaoBiaoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        synchronized (this) {
            ...
            pr.CKBBCreat(1,17,"");
            pr.getP().setDataList(StockrecordDao.allCK(pr.getP().getCurrentPage() * pr.getP().getPageSize(), pr.getP().getPageSize(),""));
            ...
            request.getRequestDispatcher("../baobiao/chukubaobiao.jsp").forward(request, response);
