        ...
        synchronized (this){
            ...
            if(flag == 1){ //全部
              ...
              if(pr.getP().getDataList().size()==0){
                ...
                pr.create(page,17,2);
                pr.getP().setDataList(PomainDao.selectByTypeOO(pr.getP().getCurrentPage() * pr.getP().getPageSize(), pr.getP().getPageSize()));
                if(pr.getP().getDataList().size()==0){
                ...
                pr.create(page,17,3);
                pr.getP().setDataList(PomainDao.selectByTypeTT(pr.getP().getCurrentPage() * pr.getP().getPageSize(), pr.getP().getPageSize()));
                if(pr.getP().getDataList().size()==0){
                ...
                pr.create(page,17,4);
                pr.getP().setDataList(PomainDao.selectByTypeTF(pr.getP().getCurrentPage() * pr.getP().getPageSize(), pr.getP().getPageSize()));
                if(pr.getP().getDataList().size()==0){
            ...
            List<Pomain> list = pr.getP().getDataList();
