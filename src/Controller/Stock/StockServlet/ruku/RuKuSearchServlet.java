 ...
 * 无效servlet
 * */
@WebServlet("/stock/lookup")
public class RuKuSearchServlet extends HttpServlet {
...
//            PageTable<PoItemMain> pr = new PageTable<>();//每页 20 个数据
...
//            }
//            pr.create(1,1);
//            pr.getP().setDataList(PoItemMainDao.selectKeyAll(pr.getP().getCurrentPage() * pr.getP().getPageSize(), pr.getP().getPageSize(),str,str2,str3,str4));
