...
public class Pomain {
    ...
    public Pomain(){}
    public Pomain(long POID,String venderCode,String account,String createTime,float tipFee,float productTotal,
                  float pOTotal,int payType,float prePayFee, int status,String remark,String stockTime,String stockUser,String payTime,
                  String payUser,String prePayTime,String prePayUser,String endTime,String endUser,String venderName){
        this.POID = POID;this.venderCode = venderCode;this.account = account;this.createTime = createTime;this.tipFee =tipFee;
        ...
        this.prePayUser = prePayUser;this.endTime = endTime;this.endUser = endUser;this.venderName = venderName;
    }
