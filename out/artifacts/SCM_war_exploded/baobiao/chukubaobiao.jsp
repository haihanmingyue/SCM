...
<div id="m">
    ...
    <div style="height: 30px;line-height: 30px;font-size: 15px">
        <a>销售单据数:<span id="itemNums">999</span></a>
        <a>|</a>
        <a>产品总数量:<span id="proNums">999</span></a>
        <a>|</a>
        <a>出库产品总金额:<span id="moneyNums">999</span></a>
    </div>
    <div id="dataList">
...
<c:forEach items="${list}" var="pr" varStatus="no">
            <tr >
                <td class="poCode" align="center"><a href="../gztm/somain_detail.jsp">${pr.orderCode}</a></td>
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    for(var i=0;i<result.length;i++){
                        table.append("<tr>"+
                            "<td class=\"poCode\" align=\"center\"><a href=\"../gztm/somain_detail.jsp\">"+re[i].c+"</a></td>" +
